                            ...
                            <li class="item" id="{{$item->category->slug}}">
                                ...
                                <a href="#">
                                    <img src="{{asset('uploads/item/'.$item->image)}}" class="img-responsive"
                                       style="height: 300px; width: 369px;"  alt="Item" >
    ...
    <div class="container-fluid color-bg">
        <div class="row dis-table">
            ...
            <div class="col-xs-6 col-sm-6 dis-table-cell">
                <div class="section-content">
                    <p>Almaty, Zhandosov street, 34</p>
                    <p>+77021890875</p>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2019 <a href="https://anarbaysanzhar1999.000webhostapp.com"> anarbaysanzhar1999 </a>  by <a href="https://vk.com/sanzharanarbay"  target="_blank">Sanzhar Anarbay</a>
                    </p>
                </div>
            </div>
        </div>
